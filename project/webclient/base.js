...
//var dataServiceBase = "http://192.168.3.105/";
var dataServiceBase = "/";

var serverIp = window.top.location.hostname;
//var serverIp = "192.168.3.105";
...
var keepLiveStatus = true;// 是否保存现场状态（顶部Tab页切换时，不包括刷新）
...
//		"editChl": new Menu(2, "ChlCfg/editChl.htm", "editChl", ["chlMgr"], "chlCfgFrame"),
		...
		"chlSignal": new Menu(2, "ChlCfg/chlSignal.htm", "IDCS_CHANNEL_SIGNAL_ACCESS_SET", [], "chlCfgFrame"),
		...
		"netBase": new Menu(2, "NetCfg/netBase.htm", "IDCS_TCP_IPV4", [], "netCfgFrame"),
		"port": new Menu(2, "NetCfg/port.htm", "IDCS_PORT", [], "netCfgFrame"),
		"pppoe": new Menu(2, "NetCfg/pppoe.htm", "PPPoE", [], "netCfgFrame"),
		...
		"timeRestart": new Menu(2, "System/timeRestart.htm", "IDCS_AUTO_MAINTENANCE", [], "systemFrame"),
		...
		"userStatus": new Menu(2, "UserMgr/userStatus.htm", "IDCS_ONLINE_USER", [], "userFrame"),
		"logoutViewAuthCfg": new Menu(2, "UserMgr/logoutViewAuthCfg.htm", "IDCS_PREVIEW_AUTHORITY_AFTER_LOGOUT", [], "userFrame"),
		...
		"pushMessage": new Menu(2, "AlarmCfg/pushMessage.htm", "IDCS_PUSH_MESSAGE", [], "alarmCfgFrame"),
