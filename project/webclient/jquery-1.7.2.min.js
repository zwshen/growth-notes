...
function cy(a) {
  return f.isWindow(a) ? a :
      a.nodeType === 9 ? a.defaultView || a.parentWindow :
                         !1
}
function cu(a) {
  if (!cj[a]) {
...
var c = a.document, d = a.navigator, e = a.location, f = function() {
  ...
  var e =
    ...
    return new e.fn.init(a, b, h)
      ...
      D = Object.prototype.hasOwnProperty, E = Array.prototype.push,
      F = Array.prototype.slice, G = String.prototype.trim,
  ...
  e.fn = e.prototype = {
    ...
    pushStack: function(a, b, c) {
      ...
      e.isArray(a) ? E.apply(d, a) : e.merge(d, a), d.prevObject = this,
    ...
    slice: function() {
      return this.pushStack(
          F.apply(this, arguments), 'slice', F.call(arguments).join(','))
    },
    map: function(a) {
  ...
  e.extend = e.fn.extend =
      function() {
    var a, c, d, f, g, h, i = arguments[0] || {}, j = 1, k = arguments.length,
                          l = !1;
  ...
  e.extend({
    ...
    parseXML: function(c) {
      ...
      try {
        a.DOMParser ?
            ...
            (d = new ActiveXObject('Microsoft.XMLDOM'), d.async = 'false',
             d.loadXML(c))
      } catch (g) {
        d = b
      }
    ...
    makeArray: function(a, b) {
      ...
      if (a != null) {
        var d = e.type(a);
        a.length == null || d === 'string' || d === 'function' ||
    ...
    sub: function() {
      ...
      e.extend(!0, a, this),
          ...
          a.fn.constructor = a, a.sub = this.sub, a.fn.init = function(d, f) {
  ...
  when: function(a) {
    ...
    f.support = function() {
      ...
      j.removeChild(p), j = g = h = p = i = null, f(function() {
        ...
        !u ||
            (m = 1, t = 'padding:0;margin:0;border:',
             ...
             d.style.cssText = s +
                 'width:0;height:0;position:static;top:0;margin-top:' + m +
                 'px',
             ...
             a.getComputedStyle &&
                 (p.innerHTML = '', l = c.createElement('div'),
                  ...
                  b.reliableMarginRight = (parseInt(
  ...
  removeData: function(a, b, c) {
    if (!!f.acceptData(a)) {
      ...
      f.support.deleteExpando || !j.setInterval ? delete j[k] : j[k] = null,
                                                                i &&
          (f.support.deleteExpando ? delete a[h] :
    ...
    f.extend({
      ...
      queue: function(a, b, c) {
        ...
        if (a) {
          ...
          c &&
              (!d || f.isArray(c) ? d = f._data(a, b, f.makeArray(c)) :
                                    d.push(c));
          return d || []
        }
      },
      dequeue: function(a, b) {
        ...
        d === 'inprogress' && (d = c.shift()),
            d &&
            (b === 'fx' && c.unshift('inprogress'), f._data(a, b + '.run', e),
             d.call(
                 a,
                 function() {
                   f.dequeue(a, b)
      ...
      removeAttr: function(a, b) {
        ...
        if (b && a.nodeType === 1) {
          ...
          for (; i < g; i++)
            e = d[i],
            e &&
                (c = f.propFix[e] || e, h = u.test(e), h || f.attr(a, e, ''),
...
f.event = {
  ...
  simulate: function(a, b, c, d) {
    var e =
        f.extend(new f.Event, c, {type: a, isSimulated: !0, originalEvent: {}});
 ...
 f.Event =
   ...
   a && a.type ?
       (this.originalEvent = a, this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || a.returnValue === !1 ||
                a.getPreventDefault && a.getPreventDefault() ?
            K :
            J) :
       this.type = a,
       b && f.extend(this, b), this.timeStamp = a && a.timeStamp || f.now(),
       this[f.expando] = !0
 },
 f.Event.prototype = {
 ...
 f.each(
     ...
     function(a, b) {
       f.event.special[a] = {
         ...
         bindType: b,
         handle: function(a) {
           var c = this, d = a.relatedTarget, e = a.handleObj, g = e.selector,
               h;
       ...
       o = m.selectors = {
         ...
         filter: {
           ...
           ATTR: function(a, b) {
             var c = b[1],
                 d = m.attr      ? m.attr(a, c) :
                 o.attrHandle[c] ? o.attrHandle[c](a) :
                 a[c] != null    ? a[c] :
                                   a.getAttribute(c),
                 e = d + '', f = b[2], g = b[4];
             return d == null ? f === '!=' :
             ...
             if (!g && !m.isXML(e)) {
               ...
               if (e.nodeType === 9) {
                 ...
                 try {
                   ...
                   e.nodeType === 1 && e.nodeName.toLowerCase() !== 'object') {
...
bg.optgroup = bg.option,
    ...
    f.fn.extend({
      ...
      domManip: function(a, c, d) {
        ...
        if (this[0]) {
          i = j && j.parentNode,
          f.support.parentNode&& i&& i.nodeType ===
                  11 && i.childNodes.length === this.length ?
              e = {fragment: i} :
         ...
         function(a, b) {
           ...
           (d = a.ownerDocument.defaultView) &&
               ...
               (c = e.getPropertyValue(b),
                c === '' && !f.contains(a.ownerDocument.documentElement, a) &&
                    (c = f.style(a, b))),
         ...
         function(a, b) {
           ...
           f == null && g && (e = g[b]) && (f = e),
               ...
               (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left,
                ...
                g.left = b === 'fontSize' ? '1em' : f, f = g.pixelLeft + 'px',
      ...
      ajax: function(a, c) {
        function w(a, c, l, m) {
          if (s !== 2) {
            ...
            t &&
                g.trigger(
                    'ajax' + (o ? 'Success' : 'Error'), [v, d, o ? r : u]),
            i.fireWith(e, [v, w]),
            t &&
...
f.ajaxSetup({
  ...
  jsonpCallback: function() {
    ...
    f.ajaxPrefilter('script', function(a) {
      ...
      if (a.crossDomain) {
        var d,
            e = c.head || c.getElementsByTagName('head')[0] ||
            c.documentElement;
        return {
          send: function(f, g) {
    ...
    return {
      send: function(e, g) {
        ...
        h.send(c.hasContent && c.data || null),
            ...
            d() :
            (i = ++cf, ce && (cg || (cg = {}, f(a).unload(ce)), cg[i] = d),
    ...
    f.extend({
      speed: function(a, b, c) {
        ...
        d.duration = f.fx.off             ? 0 :
            ...
            d.duration in f.fx.speeds     ? f.fx.speeds[d.duration] :
...
'getBoundingClientRect' in c.documentElement ?
    ...
    cv =
      ...
      while ((a = a.parentNode) && a !== h && a !== c) {
        ...
        d = i ? i.getComputedStyle(a, null) : a.currentStyle, k -= a.scrollTop,
        l -= a.scrollLeft,
        a === e &&
            (k += a.offsetTop, l += a.offsetLeft,
            ...
            return f.access(this, function(a, e, g) {
              ...
              if (g === b)
                return h ? c in h ? h[c] :
                           ...
                           a[e];
              h ? h.scrollTo(
                      d ? f(h).scrollLeft() : g, d ? g : f(h).scrollTop()) :
                  a[e] = g
